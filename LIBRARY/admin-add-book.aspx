<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin-add-book.aspx.cs" Inherits="LIBRARY_admin_add_book" %>
...
<html lang="en">
   <head>
      ...
      <title>TCLI e-LIBRARY | Add Books</title>
      <!-- Favicon -->
                      ...
                      <ul id="iq-sidebar-toggle" class="iq-menu">
                          <li class="active active-menu">
                              <ul id="dashboard" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                                  ...
                                  <li class="active"><a href="admin-books.html"><i class="ri-heart-line"></i>Manage Books</a></li>
              ...
              <div class="iq-navbar-custom">
                  <nav class="navbar navbar-expand-lg navbar-light p-0">
                      ...
                      <div class="navbar-breadcrumb">
                          <h4 class="mb-0 text-dark">Add Books</h4>
                      </div>
