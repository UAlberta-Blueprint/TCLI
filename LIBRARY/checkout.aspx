<%@ Page Language="C#" AutoEventWireup="true" CodeFile="checkout.aspx.cs" Inherits="LIBRARY_checkout" %>
...
<html lang="en">
   <head>
      ...
      <title>TCLI e-LIBRARY | Checkout</title>
      <!-- Favicon -->
                  ...
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                     <li class="active active-menu">
                        ...
                        <ul id="dashboard" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                           ...
                           <li class="active"><a href="Checkout.html"><i class="ri-checkbox-multiple-blank-line"></i>Checkout</a></li>
