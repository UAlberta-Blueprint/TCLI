<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin-add-author.aspx.cs" Inherits="LIBRARY_admin_add_author" %>
...
<html lang="en">
   <head>
      ...
      <title>TCLI e-LIBRARY | Add Authors</title>
      <!-- Favicon -->
                      ...
                      <ul id="iq-sidebar-toggle" class="iq-menu">
                          <li class="active active-menu">
                              <ul id="dashboard" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                                  ...
                                  <li><a href="admin-category.html"><i class="ri-function-line"></i>Manage Book Category</a></li>
                                  <li class="active"><a href="admin-author.html"><i class="ri-checkbox-multiple-blank-line"></i>Manage Author</a></li>
              ...
              <div class="iq-navbar-custom">
                  <nav class="navbar navbar-expand-lg navbar-light p-0">
                      ...
                      <div class="navbar-breadcrumb">
                          <h4 class="mb-0 text-dark">Add Authors</h4>
                      </div>
