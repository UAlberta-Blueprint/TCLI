...
public partial class signup :  System.Web.UI.Page
{
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        else if (pass1.Value == pass2.Value & CheckBox1.Checked == true)
        {
            ...
            //SQL Command
            string query1 = "INSERT INTO tbl_aretemedia_orders (fname, email, location, mobi, acct_type, token, code, status, created_on) VALUES ('" + fname.Value + "', '" + myemail.Text + "','" + DDList1.SelectedItem + "', '" + mymobile.Value + "', '" + DDList2.SelectedItem + "', '" + flame + "', '" + trans_pass() + "', '" + "INITIATED" + "', '" + DateTime.Today + "')";
