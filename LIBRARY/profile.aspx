<%@ Page Language="C#" AutoEventWireup="true" CodeFile="profile.aspx.cs" Inherits="LIBRARY_profile" %>
...
<html lang="en">
   <head>
      ...
      <title>TCLI e-LIBRARY | Profile</title>
      <!-- Favicon -->
                     ...
                     <ul class="navbar-nav ml-auto navbar-list">
                        ...
                        <li class="line-height pt-3">
                           <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                              ...
                              <div class="caption">
                                 <h6 class="mb-1 line-height">Tope Obi Musa</h6>
                              </div>
                           </a>
                           <div class="iq-sub-dropdown iq-user-dropdown">
                              <div class="iq-card shadow-none m-0">
                                 <div class="iq-card-body p-0 ">
                                    <div class="bg-primary p-3">
                                       <h5 class="mb-0 text-white line-height">Hello Tope Obi Musa</h5>
                           ...
                           <ul class="list-inline p-0 mb-0">
                              ...
                              <li>
                                 <div class="row align-items-center justify-content-between mb-3">
                                    ...
                                    <div class="col-sm-6">
                                       <p class="mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="24664556565d64415c45495448410a474b49">[email&#160;protected]</a></p>                                       
                                    </div>
                                 </div>
                              </li>
                              <li>
      ...
      <!-- color-customizer -->
       <div class="iq-colorbox color-fix">
           ...
           <div class="clearfix color-picker">
               <h3 class="iq-font-black">TCLI e-LIBRARY Awesome Color</h3>
